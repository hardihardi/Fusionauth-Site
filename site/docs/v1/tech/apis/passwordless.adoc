...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Generate a passwordless login code
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock-alt[role=green,type=far]] Send the provided code via email
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock-alt[role=green,type=far]] Generate a code and send a login link via email
...
[.api-authentication]
link:authentication#api-key-authentication[icon:unlock-alt[role=green,type=far]] Login using the code sent via email
[.endpoint]
.URI
--
