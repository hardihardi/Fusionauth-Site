...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Enable Two Factor Authentication
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=far]] Enable Two Factor Authentication
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Disable Two Factor Authentication
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=far]] Disable Two Factor Authentication
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Send a Two Factor code to an existing User by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Send a Two Factor code to a mobile phone
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/two-factor/send#
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock-alt[role=green,type=far]] Send a Two Factor code to complete Two Factor Login
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=far]] Send a Two Factor code to an authenticated User using a JWT
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/two-factor/send#
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Generate a Two Factor Secret
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=far]] Generate a Two Factor Secret
[.endpoint]
.URI
--
[method]#GET# [uri]#/api/two-factor/secret#
