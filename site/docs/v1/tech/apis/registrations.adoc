...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Create a User Registration for an existing User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Create a User and a User Registration in a single API call
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/user/registration/``\{userId\}``#
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve a User Registration for the User Id and Application Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Update a User Registration
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Delete a User Registration by providing the User Id and the Application Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock-alt[role=green,type=far]] Verifies the User Registration using a `verificationId`.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock-alt[role=green,type=far]] Resend the registration verification email
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Resend the registration verification email using an API key
[.endpoint]
.URI
--
