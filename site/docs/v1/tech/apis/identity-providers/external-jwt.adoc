...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=far]] Create an Identity Provider using a randomly generated id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=far]] Create an Identity Provider with the provided unique id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve an external JWT Identity Provider by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:../authentication#api-key-authentication[icon:lock[role=red,type=far]] Delete an Identity Provider by Id
[.endpoint]
.URI
--
