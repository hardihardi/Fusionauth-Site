...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Generates the {reportType} report
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Generates the {reportType} report for an individual user by username or email address
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Generates the {reportType} report for an individual user by unique Id
[.endpoint]
.URI
--
