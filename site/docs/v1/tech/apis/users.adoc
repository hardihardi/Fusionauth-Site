...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Create a User with a randomly generated Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Create a User with the provided unique Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve a User by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve a User by login Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve a User by email
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve a User by username
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve a User by Change Password Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve a User by Email Verification Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=far]] Retrieve a User using a JWT
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Update the User with the given Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Deactivate a User (Soft Delete)
[.endpoint]
.URI
--
...
--
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Permanently Delete a User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Deactivate Users by User Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Deactivate Users by Search Query String
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Permanently Delete Users by User Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Permanently Delete Users by Search Query String
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Bulk delete using the request body. This allows for larger requests than are possible using request parameters.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Reactivate the User
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Import Multiple Users
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Search for Users by Id
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Search for Users by a query string
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Search for Users by a query string and sort the response
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Search for Users using a JSON request body. This allows for larger requests than are possible using request parameters.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Retrieve recent logins
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock-alt[role=green,type=far]] Verifies the User's email address using the `verificationId`.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock-alt[role=green,type=far]] Resend the verification email
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Resend the verification email using an API key
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#no-authentication-required[icon:unlock-alt[role=green,type=far]] Start the forgot password workflow without an API Key.
[.endpoint]
.URI
--
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Start the forgot password workflow using an API key
[.endpoint]
.URI
--
[method]#POST# [uri]#/api/user/forgot-password#
...
|403
|The forgot password functionality has been disabled. This is caused by an administrator setting the Forgot Password Email Template to the option _Feature Disabled. No template selected._ in the Tenant Email configuration. See [breadcrumb]#Tenants# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#Email# icon:chevron-right[role=breadcrumb,type=fas] [breadcrumb]#Teplate settings# in the FusionAuth admin UI.
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Changes a User's password using an email address or username.
...
[.api-authentication]
link:authentication#jwt-authentication[icon:id-badge[role=green,type=far]] Changes a User's password using a JWT
...
[.api-authentication]
link:authentication#api-key-authentication[icon:lock[role=red,type=far]] Flushes the Search Engine
[.endpoint]
.URI
--
